		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFlowSpecificationAccess().getOwnedFlowsAssignment_1(), "rule__FlowSpecification__OwnedFlowsAssignment_1");
					put(grammarAccess.getFlowAccess().getNameAssignment_1(), "rule__Flow__NameAssignment_1");
					put(grammarAccess.getFlowAccess().getDomainAssignment_3(), "rule__Flow__DomainAssignment_3");
					put(grammarAccess.getFlowAccess().getKindAssignment_4_1(), "rule__Flow__KindAssignment_4_1");
					put(grammarAccess.getFlowAccess().getAttributeAssignment_5_1(), "rule__Flow__AttributeAssignment_5_1");
					put(grammarAccess.getEventSpecificationAccess().getOwnedEventsAssignment_1(), "rule__EventSpecification__OwnedEventsAssignment_1");
					put(grammarAccess.getEventAccess().getNameAssignment_1(), "rule__Event__NameAssignment_1");
					put(grammarAccess.getEventAccess().getOwnedPriorityAssignment_2_1(), "rule__Event__OwnedPriorityAssignment_2_1");
					put(grammarAccess.getEventAccess().getAttributeAssignment_3_1(), "rule__Event__AttributeAssignment_3_1");
					put(grammarAccess.getPriorityAccess().getOwnedExpressionAssignment_1(), "rule__Priority__OwnedExpressionAssignment_1");
					put(grammarAccess.getStateSpecificationAccess().getOwnedStatesAssignment_1(), "rule__StateSpecification__OwnedStatesAssignment_1");
					put(grammarAccess.getStateAccess().getNameAssignment_1(), "rule__State__NameAssignment_1");
					put(grammarAccess.getStateAccess().getDomainAssignment_3(), "rule__State__DomainAssignment_3");
					put(grammarAccess.getStateAccess().getAttributeAssignment_4_1(), "rule__State__AttributeAssignment_4_1");
					put(grammarAccess.getDomainRefAccess().getReferenceAssignment(), "rule__DomainRef__ReferenceAssignment");
					put(grammarAccess.getNodeInstanceSpecificationAccess().getOwnedNodeInstancesAssignment_1(), "rule__NodeInstanceSpecification__OwnedNodeInstancesAssignment_1");
					put(grammarAccess.getNodeInstanceAccess().getNameAssignment_1(), "rule__NodeInstance__NameAssignment_1");
					put(grammarAccess.getNodeInstanceAccess().getNodeTypeAssignment_3(), "rule__NodeInstance__NodeTypeAssignment_3");
					...
					put(grammarAccess.getTransitionAccess().getOwnedExpressionAssignment_0(), "rule__Transition__OwnedExpressionAssignment_0");
					...
					put(grammarAccess.getAssignmentAccess().getStateAssignment_0(), "rule__Assignment__StateAssignment_0");
					put(grammarAccess.getAssignmentAccess().getOwnedExpressionAssignment_2(), "rule__Assignment__OwnedExpressionAssignment_2");
